...
ops.recorder('Node', '-file', output_directory+'/001_pushover_col_glob_disp.out',
             '-node', 20,  '-dof', 1,  'disp')
ops.recorder('Node', '-file', output_directory+'/001_pushover_col_glob_force.out',
...
ops.recorder('Element', '-file', output_directory+'/001_pushover_col_force.out',
             '-ele', 1020,  'section',  'force')
ops.recorder('Element', '-file', output_directory+'/001_pushover_col_deform.out',
...
Dmax  = 0.05*m; 	# 0.40m   maximum displacement of pushover. It could also be for example 0.1*$H1
...
Pushover_topDisp = np.loadtxt(output_directory+'/001_pushover_col_glob_disp.out')
total_base_reaction = np.loadtxt(output_directory+'/001_pushover_col_glob_force.out')
