...
for node_sensor in cycle_nodes_1:
    
    for node2 in cycle_nodes_2:
        
        # df_lag = pd.DataFrame( index = ['N. GMs', 'Conf w/o Lag', 'Conf w/ Lag'], columns = ['Lag 0'])
        # df_lag.loc['N. GMs', 'Lag 0'] = 0
        # df_lag.loc['Conf w/o Lag', 'Lag 0'] = 0
        # df_lag.loc['Conf w/ Lag', 'Lag 0'] = 0
