...
folder_lf_1 = r'output_files_LF_1'  
folder_lf_0 = r'output_files_LF_0'
folder_lf_2 = r'output_files_LF_2'

folder_lf_2C = r'output_files_LF_2C'
...
# OG LF = 1
folder_lf_OG_1 = r'output_files'
df_Results_OG1 = pd.read_pickle(os.path.join(folder_lf_OG_1, '00_Index_Results.pkl'))

# OG LF = 1 (ALL)
folder_lf_OG_1_ALL = r'output_files_ALL'
df_Results_OG1_ALL = pd.read_pickle(os.path.join(folder_lf_OG_1_ALL, '00_Index_Results.pkl'))
